...
let viewTablesPromise = query.getViewTables(connection, query.escapeQuotes)
    ...
    .then(sideEffect(filename => console.log(`${filename} was generated successfully`)))
    .catch(console.log);
...
let triggersPromise = query.getTriggers(connection, query.escapeQuotes, _)
    ...
    .then(sideEffect(filename => console.log(`${filename}_create_view_tables.php was generated successfully`)))    
    .catch(console.log);
